/**
 * 공통 컴포넌트에서 함께 사용하는 기본 컴포넌트들입니다.
 * 기존에는 adapter/form 내부에 있었으나 사용 범위를 확장하기 위해 외부로 추출하여 다른 곳에서도 사용할 수 있도록 했습니다.
...
// 여기서는 비즈니스 컴포넌트 라이브러리에 따라 자체적으로 조정해야 하며, 사용되는 컴포넌트는 모두 여기에 타입 설명이 필요합니다.
...
async function initComponentAdapter() {
  const components: Partial<Record<ComponentType, Component>> = {
    // 컴포넌트 용량이 큰 경우 비동기 로딩을 사용할 수 있습니다.
    // Button: () =>
